...
(function(MM){
MM.Follower = function(map, location, content, dimensions,name) {
    ...
    MM.addEvent(this.div, 'mouseover', function(e){
		var labeltje = document.createElement('p');
		labeltje.id = name;
		labeltje.textContent = name;
		labeltje.style.color = '#F03';		
		//labeltje.style.background ='#FFF'
		labeltje.coord = map.locationCoordinate(location);	
		this.appendChild(labeltje);
	});
